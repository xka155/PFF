...
'''
Class representing a datafeed. This is the main access point for data providers.
It contains all datasources it needs and delegates queries to them.

Params:
    datasources (list[Obj]): list of datasources initialised as DataSource objs

Attributes:
    sources (dict(Enum => Obj)): Dictionary of datasources

Raises:
    query_source (KeyError): Raises KeyError if datasource is not valid/present
